...
DISCOUNT_LIST = {
    ...
    '2B': {
        'discount': 15,
        "loading_factor": ProductDiscountFactor(cross_product_name='E'),
        'rules': {
            'min': 2,
            'max': 2,
        }
...
class CrossProductDiscountFactorFactory:

    def __init__(self, cross_product_name, discounts_to_apply=[]):
        self.discounts_to_apply = discounts_to_apply
